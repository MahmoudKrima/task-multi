...
<head>
    ...
    <title>{{ app('settings')['app_name_' . app()->getLocale()] }} | {{ __('admin.reset_password') }} </title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" method="POST" action="{{ route('auth.resetPasswordSubmit') }}">
                            @csrf
                            <div class="form">

                                <div id="email-field" class="field-wrapper input">
                                    <div class="d-flex justify-content-between">
                                        <label for="otp">{{ __('admin.otp') }}</label>
                                    </div>
                                    ...
                                    <input id="otp" name="otp" type="text" class="form-control"
                                        value="" placeholder="{{ __('admin.otp') }}">
                                </div>
                                <div id="email-field" class="field-wrapper input">
                                    <div class="d-flex justify-content-between">
                                    ...
                                    <input id="password" name="password" type="password" class="form-control"
                                        value="" placeholder="{{ __('admin.password') }}">
                                </div>
                                <div id="password-field" class="field-wrapper input">
                                    <div class="d-flex justify-content-between">
                                        <label
                                            for="password_confirmation">{{ __('admin.password_confirmation') }}</label>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-at-sign">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-danger"
                                            value="">{{ __('admin.reset_password') }}</button>
                                    </div>
                                </div>
